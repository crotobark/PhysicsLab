...
- **Библиотека physicslab** — встроенная Python библиотека с классами:
  ...
  - `Ball` — шарики/частицы
  - `Platform` — платформы
- **Canvas Visualization** — HTML5 Canvas отрисовка объектов в реальном времени
  - Автоматическое масштабирование под размер окна
  - Визуализация Ball (круги) и Platform (прямоугольники)
  - Отображение векторов скорости
  - Информационная панель (количество тел, гравитация, размер мира)
